...
export default function Users() {
  ...
  const handleSingleUserCreate = (userData) => {
    console.log('Creating single user:', userData);
    // Add logic to call API or update state
  };

  const handleBulkUserCreate = (file) => {
    console.log('Uploading bulk user file:', file);
    // Add logic to process/upload the CSV/Excel file
  };
    ...
    return (
      <>
        ...
        <UserCreatePopup
          ...
          onSubmitSingle={handleSingleUserCreate}
          onSubmitBulk={handleBulkUserCreate}
        />
      </>
    );
  };
